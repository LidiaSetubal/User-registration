...
const speed1 = prompt("Enter the speed of the first vehicle:");

const vehicle2 = prompt("Enter the name of the second vehicle:");
const speed2 = prompt("Enter the speed of the second vehicle:");
...
if ( speed1 > speed2 ) {
  ...
  alert(vehicle1 + "and" + vehicle2 + "have tha same speed")
}
